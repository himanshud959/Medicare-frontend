...
const Signup = () => {
  ...
  const [previewURl, setPrevviewURl] = useState("");
          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="mb-5 flex items-center justify-between">
                <label className="text-headibgColor font-bold text-[16px] leading-7">
                  Are you a:
                  <select
                    name="role"
                    value={formData.role}
              ...
              <div className="mt-7">
                <button
                  ...
                  type="submit"
                  className="w-full bg-primaryColor text-white text-[18px] teading-[30px] rounded-lg px-4 py-3"
                >
                  {loading ? (
