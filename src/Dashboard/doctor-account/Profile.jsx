...
const Profile = ({ doctorData }) => {
  ...
  //Reusable function to adding items
  ...
  //Reusable function to handle change
  ...
  const handleTimeSlotChange = (event, index) => {
    ...
    setFormData((prevFormData) => {
      ...
      updateItems[index][event.target.name] = event.target.value;
  ...
  return (
    <div>
      <h2 className="texr-headingColor font-bold text-[24px] leading-9 mb-10">
        Profile Information
      </h2>
      <form>
        <div className="mb-5">
          ...
          <div className="grid grid-cols-3 gap-5 mb-[30px]">
            ...
            <div>
              ...
              >
                ...
                <option value="neurologist">Neurologist</option>
                <option value="cardiology">Cardiology physician</option>
          ...
          <div className="relative w-[130px] h-[50px]">
            ...
            <label
              ...
              className="absolute top-0 left-0 w-full h-full flex items-center 
                  ...
                  font-semibold rounded-lg truncacte cursor-pointer"
            >
              Upload Photo
            </label>
          </div>
        ...
        <div className="mt-7">
          <button
            ...
            className="bg-primaryColor text-white text-[18px] leading-[30px] w-full rounded-lg px-4 py-3"
          >
            Update Profile
          </button>
        </div>
