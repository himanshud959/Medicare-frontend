      ...
      <div className="max-w-[1170px] px-5 mx-auto">
        ...
        {!loading && !error && (
          <div className="grid lg:grid-cols-3 gap-[30px] lg:gap-[50px]">
            <Tabs tab={tab} setTab={setTab} showTab={showTab} setShowTab={setShowTab} />
                ...
                {tab === "overview" && (
                  <div>
                    <div className="flex flex-col lg:flex-row items-center gap-4 mb-10">
                      ...
                      <div>
                        <span
                          className="bg-[#CCF0F3] text-irisBlueColor py-1 px-4 lg:py-2 lg:px-6 rounded text-[12px] leading-4 lg:text-[16px]
