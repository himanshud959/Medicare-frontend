        ...
        <div className="flex justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
            ...
            <p className="text__para">
              ...
              Texas. Loren ipsum dolor sit amed consectetur, adipisicing elit.
              Quas, nemo?
            </p>
            <p className="text__para mt-[30px]">
              Our best is something we strive for each day, caring for our
              patirnts-not looking back at what we accomplished but towards what
              we can do tomarrow. Providing the best. Loren ipsum dolor sit amed 
